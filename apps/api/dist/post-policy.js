...
function getConfig() {
    return {
        ...
        expireSeconds: parsePositiveInteger(process.env.OSS_POST_POLICY_EXPIRE_SECONDS, DEFAULT_POST_POLICY_EXPIRE_SECONDS),
...
export async function createPostPolicy() {
    ...
    const temporaryCredentials = await stsClient.assumeRole(config.roleArn, assumeRolePolicy, stsDurationSeconds, sessionName);
